...
|---------|-----------------|-------------------|
| Brand switcher | Left sidebar | "the **brand switcher** in the sidebar" |
| Pillar access | Left sidebar | "open **[Pillar Name]** from the sidebar" |
| AskFrnd (panel) | Right side of screen | "open AskFrnd from the **right side** of the page" |
| AskFrnd (full) | Left sidebar → Chat | "open **Chat** from the **left sidebar**" |
| Workspace switcher | Left sidebar | "the workspace switcher in the sidebar" |

**Never use:** "top-left dropdown", "top navigation bar", "header menu"

> **Update this section** whenever navigation changes are confirmed in a product showcase.
...
### Article language
**English** — unless user specifically requests Bahasa Indonesia or bilingual.
